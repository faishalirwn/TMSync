...
/**
 * Recipe-snapshot harness: given saved page HTML + the shipped recipe list,
 * assert the parsed media. Most regressions are "recipe rot" — selectors that
 * stop matching when a site changes — and this is what catches them early.
 */
