...
export const RECIPES = {
  url:
    ...
    "https://raw.githubusercontent.com/faishalirwn/TMSync/main/recipes/index.json",
  /** Re-fetch at most this often. */
  refreshMs: 12 * 60 * 60 * 1000,
  /** Where contributors open a PR to add a site. */
  contributeUrl: import.meta.env.WXT_RECIPES_REPO || "https://github.com/faishalirwn/TMSync",
} as const;
